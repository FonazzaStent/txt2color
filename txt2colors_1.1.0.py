...
img=""
...
#separatingline
separatingline= ttk.Separator(top)
separatingline.place(relx=0.748, rely=0.694,  relwidth=0.221)
...
#PasteButton
PasteButton=Button(top)
PasteButton.place(relx=0.765, rely=0.719, height=24, width=47)
PasteButton.configure(text='''Paste''')

#GenerateColorButton
GenerateColorButton=Button(top)
GenerateColorButton.place(relx=0.765, rely=0.797, height=24, width=87)
GenerateColorButton.configure(text='''Generate color''')

#ClearButton
ClearButton=Button(top)
ClearButton.place(relx=0.85, rely=0.719, height=24, width=47)
ClearButton.configure(text='''Clear''')

#QuitButton
QuitButton=Button(top)
QuitButton.place(relx=0.765, rely=0.873, height=24, width=47)
...
GenerateColorButton.bind("<Button-1>",GenerateColor)
